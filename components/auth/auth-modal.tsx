...
import { X, Chrome, User, Loader2 } from 'lucide-react';
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-2xl tracking-tight">MEMO</span>
          </div>
        </div>
        ...
        <p className="text-center text-gray-500 mb-8">
          Sign in to continue to Memo Chat
        </p>
        ...
        <div className="space-y-3">
          <button
            ...
            className={cn(
              'w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl',
